...
export default function Hero() {
  return (
    <section className="py-20 md:py-28 bg-secondary/30 relative overflow-hidden">
      <div className="absolute inset-0 z-0 bg-background [mask-image:radial-gradient(ellipse_70%_60%_at_50%_0%,#000_60%,transparent_100%)]">
        <div
          className="absolute inset-0 bg-[linear-gradient(to_right,hsl(var(--border))_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--border))_1px,transparent_1px)] bg-[size:20px_30px]"
        ></div>
      </div>
      <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-primary/20 rounded-full filter blur-3xl opacity-50 animate-blob-bounce -z-10"></div>
      <div className="container text-center relative">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mt-6">
          Stop sharing your profits. Crevings empowers you to grow your business with a flat, transparent subscription. More earnings, more control—all yours.
        </p>

        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button variant="outline" size="lg" asChild className="font-headline">
