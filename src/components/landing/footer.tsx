...
export default function Footer() {
  // 🔥 Using old UI href links exactly as they were
  const companyLinks = [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3">
              <Logo className="text-white w-56 h-auto" />
            </Link>
            ...
            <div className="flex gap-4 pt-4">
              <Link
                href="#"
                className="text-primary-foreground/80 hover:text-primary-foreground transition-all duration-300 hover:scale-125"
              >
                <Twitter className="h-6 w-6" />
              </Link>

              <Link
                href="https://www.instagram.com/mycrevings?igsh=ODU5dm44YnE1MGRz"
                className="text-primary-foreground/80 hover:text-primary-foreground transition-all duration-300 hover:scale-125"
              >
              ...
              <Link
                href="https://www.linkedin.com/company/crevings/"
                className="text-primary-foreground/80 hover:text-primary-foreground transition-all duration-300 hover:scale-125"
              >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">
                  Innov8, Lower Ground Floor, Saket Salcon, Rasvilas, next to Select Citywalk Mall, Saket District
                  Centre, District Centre, Sector 6, Pushp Vihar, New Delhi, Delhi 110017
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-5 w-5" />
                <a href="mailto:support@crevings.com" className="hover:text-primary-foreground transition-colors text-sm">
                  support@crevings.com
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-5 w-5" />
                <a href="tel:+911234567890" className="hover:text-primary-foreground transition-colors text-sm">
                  +91 123 456 7890
                </a>
              </li>
            </ul>
