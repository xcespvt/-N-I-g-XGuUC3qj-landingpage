...
const starterPerks = [
    {
        category: "Core Features", features: [
            "Multi-Branch System - Includes 1 free branch add-on (" + <IndianRupee className="h-4 w-4 inline mr-1" /> + "99 per extra branch thereafter)",
...
const growthPerks = [
    { category: `Multi-Branch System - Includes 3 free branch add-ons (+${<IndianRupee className="h-4 w-4 inline mr-1" />}99 per extra branch thereafter)` },
    {
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
                    ...
                    <Card className="h-full flex flex-col border-2 border-primary shadow-2xl shadow-primary/20 relative">
                        ...
                        <CardHeader className="p-6 pb-0">
                            ...
                            <div className="flex items-baseline gap-2 pt-4">
                                <span className="text-5xl font-bold font-headline"><IndianRupee className="h-4 w-4 inline mr-1" />499</span>
                                <span className="text-muted-foreground">/month</span>
                            </div>
                            <p className="text-sm text-muted-foreground mt-1">+ 18% GST</p>
                            <p className="text-sm font-semibold pt-2 text-primary">Everything in Starter ${<IndianRupee className="h-4 w-4 inline mr-1" />}399 Plan PLUS:</p>
                        </CardHeader>
                        <CardContent className="p-6 pt-6 flex-1 flex flex-col">
                            <div className="space-y-6">
