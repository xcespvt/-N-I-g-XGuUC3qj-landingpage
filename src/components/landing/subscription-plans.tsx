...
const starterPerks = [
    {
        ...
        features: [
            <>
                Multi-Branch System - Includes 1 free branch add-on (
                <IndianRupee className="inline h-4 w-4" />
                99 per extra branch thereafter)
            </>,
        ...
        <section id="subscription" className="py-12 sm:py-20 lg:py-24">
            <div className="container">
                <div className="max-w-3xl mx-auto text-center">
                    <Button variant="outline" className="rounded-full mb-4 border-primary text-primary hover:bg-primary/10 hover:text-primary font-bold" disabled>Subscription</Button>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
                    {/* Starter Plan */}
                    <Card className="p-2 bg-background relative border-2 flex flex-col">
                    ...
                    {/* Growth Plan */}
                    <Card className="p-2 bg-background relative border-2 border-primary flex flex-col">
                        ...
                        <CardHeader className="p-6">
                            ...
                            <div className="flex items-baseline gap-2 pt-4">
                                <span className="text-5xl font-bold font-headline">₹999</span>
                                <span className="text-muted-foreground">/month</span>
                            </div>
                            <p className="text-sm text-muted-foreground mt-1">+ 18% GST</p>
