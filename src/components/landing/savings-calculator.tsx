          ...
          <CardContent className="p-8 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <Card className="p-6 bg-primary/10 border-primary/30">
                    ...
                    <p className="text-3xl font-bold font-headline mt-2">{formatCurrency(amount - crevingsCost)}</p>
                    <p className="text-sm mt-1">
                        <span className="text-primary font-headline italic text-shadow-glow">You Keep</span>
                    </p>
                </Card>
                 <Card className="p-6 bg-muted/50 border-border">
                    <p className="font-bold text-muted-foreground">Zomato</p>
                 ...
                 <Card className="p-6 bg-muted/50 border-border">
                    <p className="font-bold text-muted-foreground">Swiggy</p>
                    <p className="text-3xl font-bold font-headline mt-2">{formatCurrency(amount - competitorCommission)}</p>
                    <p className="text-sm text-muted-foreground/80 mt-1">You would keep</p>
                </Card>
            </div>
             <p className="text-xs text-muted-foreground mt-4 text-center max-w-2xl mx-auto">
                *Calculation based on data we collect from food partners. We take an average 35% commission for Zomato/Swiggy which includes base commission, GST on commission, and other charges.
            </p>
          </CardContent>
        </Card>
      </div>
